...
public class RegisterScreen extends javax.swing.JFrame {
    ...
    private void registerButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerButActionPerformed
        Patient patient=new Patient(idnumber.getText(),name.getText(),surname.getText(),String.valueOf(password.getPassword()));
        mysql.addPatient("INSERT INTO patient_table(patient_id,patient_name,patient_surname,patient_password) VALUES ("+"'"+patient.getPatientID()+"'"+","+"'"+patient.getPatientName()+"'"+","+"'"+patient.getPatientSurname()+"'"+","+"'"+String.valueOf(patient.getPatientPassword())+"'"+")");
        new LoginScreen();
